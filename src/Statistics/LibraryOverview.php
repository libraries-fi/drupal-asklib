...
class LibraryOverview extends StatisticsBase {
  public function getId() {
    return 'asklib_library_overview';
  }
  ...
  public function execute() {
    $view = [
      ...
      'by_library' => $this->countByLibrary(),
      'pager' => [
        '#type' => 'pager'
      ]
    ];
  ...
  protected function countByLibrary() {
    ...
    if (!empty($this->parameters['t'])) {
      $vid = $this->parameters['t'] == 'city' ? 'asklib_municipalities' : 'asklib_libraries';
